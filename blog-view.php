        ...
        echo "<section class='about-section'>
            <div class='row'>
                <div class='col-md-6 d-flex ftco-animate'>
                    <img src='images/blog-view.png'>
                </div>
                <div class='col-md-6 d-flex ftco-animate'>  
                    <div class='about-content' style='padding:100px'>
                        <div class='section-title'>";
                            
                            $q=mysqli_query($c,"select blog_sub, blog_title from blogs where blog_id='".$_GET['blog_id']."'");
                   ...
                   echo " </div>
                    ...
                    $q=mysqli_query($c,"select subtitle,blog_details from blog_text where blog_id='".$_GET['blog_id']."'");
