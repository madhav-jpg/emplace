<?php
    ...
    {
            $insert_message = "insert into contact(name, mob_num, email, subject, message) values(?, ?, ?, ?, ?);";
            $stmt = mysqli_prepare($c, $insert_message);
            mysqli_stmt_bind_param($stmt, "sisss", $name, $mob_num, $email, $subject, $message);
            extract($_POST);
...
<body>
  ...
  <section class="ftco-section contact-section bg-light">
    <div class="container">
      <div class="row d-flex mb-5 contact-info">
        ...
        <div class="w-100"></div>
        <div class="col-md-3">
          <p><span>Address:</span> Madhav Kotecha, Darshan Institute of Engineering and Technology, Rajkot, Gujarat,
            India</p>
        </div>
        <div class="col-md-3">
          <p><span>Phone:</span> <a href="tel://1234567920">+91 70169 62649</a></p>
        </div>
        <div class="col-md-3">
          <p><span>Email:</span> <a href="#">210540107501@darshan.ac.in</a></p>
        </div>
        <div class="col-md-3">
          <p><span>Website</span> <a
              href="https://www.linkedin.com/in/madhav-kotecha">https://www.linkedin.com/in/madhav-kotecha</a></p>
        </div>
      </div>
      <div class="row block-9">
        <div class="col-md-6 order-md-last d-flex">
          <form method="POST" class="bg-white p-5 contact-form">
            ...
            <div class="form-group">
              <input type="text" name="mob_num" class="form-control" placeholder="Your Mobile Number">
            </div>
            <div class="form-group">
  ...
  <script defer src="https://static.cloudflareinsights.com/beacon.min.js/vaafb692b2aea4879b33c060e79fe94621666317369993"
    ...
    data-cf-beacon='{"rayId":"76da92f47a458a14","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2022.11.0","si":100}'
